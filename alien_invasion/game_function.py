...
def fire_bullet(ai_settings,screen,ship,bullets):
    ...
    # Create a new bullet and add to bullets grp.
...
def check_events(ai_settings, screen, states, sb, play_button, ship, aliens, bullets):
    #Responce to keypresses and mouse events
...
def update_screen(ai_settings, screen, states, sb, ship, aliens, bullets, play_button):
    ...
    #Redrw the screen duri ng each pass through the loop.
...
def check_bullet_alien_collisions(ai_settings, screen, states, sb, ship, aliens, bullets):
    ...
    #Remov any bullets  and aliens that have collided
...
def get_number_aliens_x(ai_settings,alien_width):
    """Determine the number of aliens thet fit in a row."""
...
def get_number_rows(ai_settings, ship_height, alien_height):
    """Determine the number if rows of aliens that fit on the screem."""
...
def update_aliens(ai_settings, screen, states, sb, ship, aliens, bullets):
    """First check if fleet is at edge then Update the positions of all aliens in the fleet."""
